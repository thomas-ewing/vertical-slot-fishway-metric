...
The fluid volume in each pool of a vertical slot fishway is turbulent. This turbulence generated by the flow through the pool. Turbulence has been identified as a factor that influences the performance of vertical slot fishways, and contemporary design criteria include guidance on fishway turbulence (O’Connor et. al., 2017).

In Australia, design criteria for turbulence are specified as limits on the pool averaged turbulent dissipation rate (PATDR), measured in W m<sup>-3</sup>. This is a pragmatic indicator of turbulence as it can be calculated from fishway flow, water level difference from the previous cell, and cell volume.

PATDR = Q * Δh * g / V

where:
 - Q is the fishway flow
 - Δh is the headloss from the upstream pool
 - g is acceleration due gravity, nd
 - V is the volume of the fishway pool

 This formulation assumes that only potential energy entering the a fishway pool contributes to dissipation and that this energy is dissipated entirely within the immediate fishway pool. This calculation does not account for the accumulation or transfer of kinitic or turbulent energy but does allow for the practical application of simple turbulence PATDR criteria.

Fish moving through vertical slot fishway pools tend to occupy and move through a consistent subset of the total pool volume (Rodríguez, Á. et al., 2015), avoiding the high velocity flow generated by the slot and other pool areas away from the upstream slot. The PATDR integrates turbulent conditions across both frequently and rarely utilised portions of the pool volume. PATDR is not likely to be representative of the average turbulence experienced by fish using the fishway.

The physical process limiting the upstream passage of fish in vertical slot fishways with high turbulence may relate to the general turbulence levels in the areas of the pool they utilise. Alternatively, fish movement could be limited by turbulence conditions in a particular part of the pool or slot that must be crossed for upstream passage. The turbulence intensity for both of these possible mechanisms are expected to be proportional to (but equal to) the PATDR.

While the PATDR may not reflect the actual turbulent conditions experienced by fish moving through a fishway, criteria have been established using numerous observations of vertical slot fishway function and corrlation of fishway function and PATDR. Application of PATDR criteria based on these correlations can be expected to be valid for geometrically similar fishways.

# References

O’Connor, J.P., Stuart, I. and Jones, M. (2017) Guidelines for the design, approval and construction of fishways. ARI Technical Report 274. Arthur Rylah Institute for Environmental Research, Department of Environment, Land, Water and Planning.

Rodríguez, Á. et al. (2015) “Fish tracking in vertical slot fishways using computer vision techniques,” Journal of Hydroinformatics, 17(2), pp. 275–292. Available at: https://doi.org/10.2166/hydro.2014.034.
