...
Fish moving through vertical slot fishway pools tend to occupy and move through a consistent subset of the total pool volume (Rodríguez, Á. et al., 2015), avoiding the high velocity flow generated by the slot and other pool areas away from the upstream slot. The PATDR integrates turbulent conditions across both frequently and rarely utilised portions of the pool volume. PATDR is not likely to be representative of the turbulence experienced by fish using the fishway.
